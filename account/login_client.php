...
<body>
    ...
    <?php include "nav.php"; ?>
     ...
     <section class="home" id="home">
        <div class="content">
            <h3>Be a client, let us serve you</h3>
            
            <a href="login_form_client.php" class="btn"> Login </a>
        </div>
     </section>
...
<section class="review" id="review">
    <h1 class="heading">Get  <span>Started </span></h1>
    <div class="box-container">
        <div class="box">
            ...
            <div class="user">
                ...
                <div class="content">
                    <a href="signup_client.php" class="btn">Sign Up </a>
                </div>
            </div>
...
<section class="review" id="review">
    <h1 class="heading">Meet  <span>Us </span></h1>
    <div class="box-container">
        <div class="box">
